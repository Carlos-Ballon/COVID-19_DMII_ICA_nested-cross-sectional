...
## Variable selection for Exploratory Data Analysis

```{r}
data_match_eda <- var_selec_eda(data_match_eda)
```
...
::: {style="text-align: justify"}
The variables with not enough events (<10) were excluded from the analysis. These were smoker, alcoholism, dislip, ecv, cancer, hiv, immunsupressive_dis, erc, hemodialisis, asma_bronquial, epc, shock_septico, disf_multiorg, f_hepatica_aguda, f_multiorganica, perdida_de_peso, poliuria, polidipysia, polifagia, sensorio, and antibiotics.
:::
